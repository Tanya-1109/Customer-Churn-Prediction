...
BINARY_COLS = [
    ...
    'PaperlessBilling', 'MultipleLines', 'SeniorCitizen'
] + SERVICE_COLS
...
NUM_COLS = [
    ...
    'is_new_customer', 'is_month_to_month',
    'is_electronic_check', 'has_internet'
]
...
def build_pipeline(model_params: dict = None) -> Pipeline:
    ...
    ], remainder='drop')  # drops customerID and other unused cols
